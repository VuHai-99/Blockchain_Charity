...
<div class="container-fluid management">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="text-left">
                    <h3 class="my-4 text-left">List tất cả yêu cầu sử dụng tiền mặt</h3>
                </div>
            </div>
...
<script src="{{ asset('js/admin_list_create_donationActivityCashout_request_blockchain.js') }}"></script>
