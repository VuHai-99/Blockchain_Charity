                    ...
                    <div id="list-cart">
                        ...
                        <div class="row" id="total-price">
                            ...
                            <div class="col-md-8 col-sm-12 col-xs-12">
                                <a href="{{ route('hostws.shopping.cart', $donationActivityAddress) }}" class="btn btn-primary">Mua
                                    tiếp</a>
                                <a href="{{ route('hostws.shopping.order.delete.cart', $donationActivityAddress) }}"
                                    ...
                                    href="{{ route('hostws.shopping.order.confirm', $donationActivityAddress) }}">Xác nhận mua hàng</a>
                            </div>
                        </div>
                    </div>
                    <hr>
