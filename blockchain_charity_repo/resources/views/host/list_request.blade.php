...
@section('pageBreadcrumb')
    <div class="group-button-top">
        <a href="{{ route('host.campaign') }}" class="btn btn-ct-primary active-primary action float-right"
            role="button">Dự án</a>
    </div>
        ...
        <div class="event-happend">
                    ...
                    <div class="information">
                        ...
                        <div class="cancel">
                            <button class="btn btn-cancel"
                                onclick="App.cancelOpenCampaignRequest('{{ $requestOpenCampaign->request_id }}')">HỦY</button>
                        </div>
                    </div>
            ...
            @foreach ($listRequestOpenDonationActivity as $requestOpenDonationActivity)
                ...
                <div class="event-item row">
                    ...
                    <div class="information">
                        <div class="campaign-name">Trực thuộc dự án : {{ $requestOpenDonationActivity->campaign->name }}
                        </div>
                        ...
                        <div class="cancel">
                            <button class="btn btn-cancel"
                                onclick="App.cancelOpenDonationCampaignRequest('{{ $requestOpenDonationActivity->request_id }}','{{ $requestOpenDonationActivity->campaign->campaign_address }}')">HỦY</button>
                        </div>
                    </div>
                </div>
                <br> <br>
                ...
                <div class="event-item row">
                    ...
                    <div class="information">
                        ...
                        <div class="campaign-address">Trong đợt từ thiện :
                            {{ $requestCreateDonationActivityCashout->donation_activity->donation_activity_name }}</div>
                        ...
                        <div class="campaign-address">Số tiền mặt muốn sử dụng :
                            @if ($requestCreateDonationActivityCashout->amount > pow(10, 17))
                                {{ number_format($requestCreateDonationActivityCashout->amount / pow(10, 17)) }}
                                (Ether)
                            @elseif($requestCreateDonationActivityCashout->amount > pow(10,8))
                                {{ number_format($requestCreateDonationActivityCashout->amount / pow(10, 8)) }}
                                (Gwei)
                            @else
                                {{ number_format($requestCreateDonationActivityCashout->amount) }} (wei)
                            @endif
                            <div class="cancel">
                                <button class="btn btn-cancel"
