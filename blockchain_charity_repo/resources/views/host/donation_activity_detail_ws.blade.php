...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item "><a style="color:black" href="{{ route('hostws.campaign.detail', $temp[6]) }}">Campaign</a></li>
            ...
            <div class="card">
                ...
                <div id="collapse96" class="collapse show" role="tabpanel" aria-labelledby="heading96">
                    ...
                    <div class="card-footer text-center">
                        <a href="{{ route('hostws.donation_activity_detail.edit',$donationActivity->donation_activity_address) }}" class="btn btn-warning" role="button">Edit Donation Activity Information</a>
                    </div>
                    @endif
                </div>
            </div>
            <div class="card">
                ...
                <div id="collapse97" class="collapse" role="tabpanel" aria-labelledby="heading97">
                    ...
                    <div class="card-footer text-center">
                        ...
                        <a href="{{ route('hostws.donationActivity.cashout.create.request', $donationActivity->donation_activity_address) }}" class="btn btn-warning" role="button">Request to create Donation Activity CashOut</a>
                    </div>
                    @endif
                </div>
            </div>
