                                    ...
                                    @if (isset($donationActivities) == true)
                                        @foreach ($donationActivities as $donationActivity)
                                            <h4 class="font-weight-bold mb-3 black-text"><a
                                                    href="{{ route('host.donationActivity.detail', ['blockchainAddress' => $campaign->campaign_address, 'donationActivityAddress' => $donationActivity->donation_activity_address]) }}">{{ $donationActivity->donation_activity_name }}</a>
                                            </h4>
                                        @endforeach
                                    @else
