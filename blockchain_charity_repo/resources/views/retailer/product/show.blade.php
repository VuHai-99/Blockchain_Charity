                    ...
                    <div class="table-responsive">
                        ...
                        <div class="row">
                            <div class="col-md-6 col-lg-6 offset-md-6">
                                <form action="{{route('product.search')}}" id="search-order">
                        ...
                        <table class="table table-bordered" style="margin-top:20px;">				
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <img width="200px" src="{{asset('products/'.$pro->image)}}" class="thumbnail">
                                        <a href="{{route('product.photos', $pro->id)}}" class="btn btn-primary">Xem ảnh mô tả</a>
                                    </td>
                                    <td>{{$pro->brand->name}}</td>
                                    <td>
                                        <a href="{{route('product.edit', $pro->id)}}" class="btn btn-warning"><i class="fa fa-pencil" aria-hidden="true"></i> Sửa</a>
                                        <a href= "{{route('product.delete', $pro->id)}}" class="btn btn-danger link-delete"><i class="fa fa-trash" aria-hidden="true"></i> Xóa</a>
                                    </td>
                                </tr>
                                @endforeach
