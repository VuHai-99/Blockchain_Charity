            ...
            <form>
              <div class="card mt-4">
                  <div class="card-header">
                    <h5 class="card-title">REQUEST TẠO ORDER TRONG ĐỢT TỪ THIỆN</h5>
                  </div>
                  <div class="card-body">
                  ...
                  <div class="card-footer">
                    <a type="button" class="btn btn-success text-light" onclick="App.responseRequestCreateDonationActivityOrder('`+totalRequestToCreateDonationActivityOrder[k]+`','`+totalCampaign[i]+`','`+request[0]+`',true); return false"> Đồng ý </a>
                    <a type="button" class="btn btn-danger text-light" onclick="App.responseRequestCreateDonationActivityOrder('`+totalRequestToCreateDonationActivityOrder[k]+`','`+totalCampaign[i]+`','`+request[0]+`',false); return false"> Từ chối </a>
                  </div>
              </div>
            </form>
          </div>`;    
