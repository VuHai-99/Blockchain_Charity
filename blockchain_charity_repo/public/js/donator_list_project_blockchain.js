App = {
  ...
  renderAllCampaign: async () => {
    ...
    const campaignTemplate = $('#recentProjects');
        ...
        let campaignItem =
            ...
            <div class="card mt-4">
                ...
                <div class="card-footer text-muted">
                  <a type="button" class="btn btn-primary" href="http://127.0.0.1:8000/charity/donator/specific-project/`+ totalCampaign[i-1] +`"> Xem chi tiết. </a>
                </div>
            </div>
        </div>`;
        // Show the task
