            ...
            <form>
              <div class="card mt-4">
                  ...
                  <div class="card-footer">
                    <a type="button" class="btn btn-success text-light" onclick="App.responseRequestValidateHost('`+totalRequestValidateHost[i]+`',true); return false"> Đồng ý </a>
                    <a type="button" class="btn btn-danger text-light" onclick="App.responseRequestValidateHost('`+totalRequestValidateHost[i]+`',false); return false"> Từ chối </a>
                  </div>
              </div>
            </form>
          </div>`;
