            ...
            <div class="row">
                ...
                <div class="col-xl-3 col-md-6 col-lg-3">
                    <div class="footer_widget">
                        ...
                        <div class="contacts">
                            <p>+2(305) 587-3407 <br> info@loveuscharity.com <br> Flat 20, Reynolds Neck, North
                ...
                <div class="col-xl-3 col-md-6 col-lg-3">
                    <div class="footer_widget">
                        ...
                        <ul class="news_links">
                            <li>
                                Vũ Hữu Hải Vũ (Blockchain - Trưởng nhóm)
                            </li>
                            <li>
                                Phạm Văn Thiện (Backend - Thành viên)
                            </li>
                            <li>
                                Kiều Văn Tùng (FrontEnd - Thành viên)
                            </li>
                        </ul>
                    </div>
                </div>
